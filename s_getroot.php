...
?>
      ...
      <div class="contact_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <h1 class="contact_text">GET ROOT</h1>
                  <h4 class="textt"><font size="4" color="white">To get the detais about your work's area enter email id below</font></h4>
...
if(isset($_POST["submit"]))
{
  ...
  if(!empty($em))
  {
     $q=mysqli_query($cn,"insert into root values('".$em."')");
     if($q)
     {
