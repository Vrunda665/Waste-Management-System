...
while($r=mysqli_fetch_array($q))
{
  ...
  echo"<td>".$r["email"]."</td>";
  echo"<td>".$r["serviceman_mobile"]."</td>";
  
?>
<td><form action="code1.php" method="POST">
     <button type="submit" name="delete" value="<?=$r['serviceman_id'];?>" style="background:green; width:90px; height:50px;">Delete</button></form></td>
   <?php
   echo"</tr>";
 }
 ?>
