            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="s_contact.php">Contact us</a>
                     </li>
                  </ul>
...
?>
      ...
      <div class="contact_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <h1 class="contact_text">FEEDBACK</h1>
                  <h4 class="textt"><font size="4" color="white"> share your experience here give us Feedback</font></h4>
                  <div class="mail_sectin">
                  <form id="register" method="POST">
                     <input type="text" class="email-bt" placeholder="Name" name="name">
                     <input type="text" class="email-bt" placeholder="Email" name="email">
                     <input type="textarea" class="massage-bt" placeholder="Massage" rows="5"  name="feedback">
                     <div class="send_bt">
      ...
      <!-- about section end -->
	    ...
	    <div class ="furnitures_section layout_padding"></div>
...
if(isset($_POST["submit"]))
{
  ...
  $p=$_POST["email"];
  $e=$_POST["feedback"];
  if(!empty($n) and !empty($p) and !empty($e))
  {	
    $q=mysqli_query($cn,"insert into s_feedback values('".$n."','".$p."','".$e."')");
     if($q)
     {
