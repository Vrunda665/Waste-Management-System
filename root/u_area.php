...
?>
      ...
      <div class="contact_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <h1 class="contact_text">ADD AREA</h1>
                  <h4 class="textt"><font size="4" color="white">Here you can add other area where garbage is appear </font></h4>
                  <div class="mail_sectin">
<form id="register" method="POST">
                     <input type="text" class="email-bt" placeholder="Name" name="name">
                     <input type="text" class="email-bt" placeholder="Email" name="email">
                     <input type="textarea" class="massage-bt" placeholder="Area Address" rows="5"  name="area">
                     <div class="send_bt">
                        <Button value="submit" id="submit" name="submit" id="submit" style="margin-left:5px;"/>&nbsp SEND &nbsp</button></div>
</form>
                  </div>
               </div>
...
if(isset($_POST["submit"]));
{
  ...
  {
       $q=mysqli_query($cn,"insert into add_area values('".$n."','".$p."','".$e."')");
       if($q)
       {
