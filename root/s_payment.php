...
?>
      ...
      <div class="contact_section layout_padding">
         <div class="container">
            <div class="row">
               <div class="col-md-6">
                  <h1 class="contact_text">PAYMENT</h1>
                  <h4 class="textt"><font size="4" color="white">Enter payment details here for get payment of your work</font></h4>
                  <div class="mail_section">
                  <form id="register" method="POST">
                  <input type="number" class="email-bt" placeholder="account no" name="account_no">
                     <input type="text" class="email-bt" placeholder="IFSC code" name="IFSC_code">
                     <div class="send_bt">
...
if(isset($_POST["submit"]));
{
  $na=$_POST["account_no"];
  $em=$_POST["IFSC_code"];
  if(!empty($na) and !empty($em))
  {
     $q=mysqli_query($cn,"insert into payment values(".$na.",'".$em."')");
     if($q)
     {
