...
$q=mysqli_query($cn,"select * from root");
while($r=mysqli_fetch_array($q))
{
  echo"<tr>";
  echo"<td>".$r["email"]."</td>";
  ?>
  <td><button type="submit" name="send" value="send" style="background:green; width:150px; height:50px;">Send Root</button</td>
   <?php
   echo"</tr>";
 }
 ?>
