   ...
   <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="aucomp.php">User complaint</a>
                     </li>   
					  <li class="nav-item">
                        <a class="nav-link" href="ascomp.php">Serviceman complaint</a>
                     </li>
				
                     <li class="nav-item">
                        <a class="nav-link" href="aufeed.php">User feedback</a>
                     </li>
					 <li class="nav-item">
                        <a class="nav-link" href="asfeed.php">Serviceman feddback</a>
                     </li>   					 
      ...
      <!-- banner section start -->
       <div class="banner_section layout_padding">
         <center>
           <table border="2" align="center" cellspacing="5" cellpadding="2" width="900" height="300">
<tr>
<th>Name</th>
<th>Email</th>
<th>feedback</th>
...
while($r=mysqli_fetch_array($q))
{
  ...
  echo" <input type="button" name="test" id="test" value="DELETE"/><br/>"
  echo"</tr>";
} 
